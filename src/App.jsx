...
import SubscriptionsScreen from "./screen/subscriptions/SubscriptionsScreen";
    ...
    <>
      ...
      <div className="app__container">
        ...
        <Container fluid className="app__main">
          {" "}
          {/*fluid container tag k sath ane wale extra padding ko hata deta hai.*/}
          {/*<HomeScreen/>*/}{" "}
          {/*is homeScreen ko hum as a parameter pass karenge layout ka*/}
          {children}
        </Container>
      </div>
    </>
...
function App() {
  ...
  return (
    <Routes>
      ...
      />
      {/* <Route path='*' element={<Layout children={<HomeScreen/>}/>}/> */}{" "}
      {/*it will create a new route per that invalid path and render our homescreen there. but Navigate will rerender from this invalid route path to homeScreen.*/}
